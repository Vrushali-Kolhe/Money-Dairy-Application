    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Boolean res = db.updateTransaction(String.valueOf(id), title, description, amount);
                if(res == false){
                    Toast.makeText(UpdateTransaction.this, "Failed", Toast.LENGTH_SHORT).show();
                }else {
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean res = myDB.deleteOneRow(String.valueOf(id));
                if(res == false){
                    Toast.makeText(UpdateTransaction.this, "Failed to Delete.", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(UpdateTransaction.this, "Successfully Deleted.", Toast.LENGTH_SHORT).show();
                }
                finish();
            }
        });
